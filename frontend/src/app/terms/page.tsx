        ...
        <div className="min-h-screen bg-paper py-20 px-6">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-4 mb-12">
                    <div className="h-12 w-12 bg-accent/10 rounded-2xl flex items-center justify-center text-accent mb-2">
                        <Gavel size={24} />
                    </div>
                ...
                <div className="mt-20 pt-8 border-t border-border-light text-center">
                    <p className="text-sm text-ink-light mb-4">Have questions about our terms?</p>
                    <a href="mailto:legal@sortmail.ai" className="btn-secondary">Contact Legal Team</a>
                </div>
            </div>
        </div>
    );
